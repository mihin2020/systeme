                            ...
                            <div class="col-8">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title">Liste des modèles de dmr</h4>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade" id="editModal{{ $model->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $model->id }}" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <form action="{{ route('model-dmr.update', $model->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('PUT')
                                                        ...
                                                        <form action="{{ route('model-dmr.destroy', $model->id) }}" method="POST" style="display: inline;">
                                                            @csrf
                                                            @method('DELETE')
                            ...
                            <div class="col-4">
                                <div class="card">
                                    ...
                                    <form action="{{ route('model-dmr.store') }}" method="POST">
                                            ...
                                            <input type="text" name="name" class="form-control" placeholder="Nom du modèle de dmr" required>
