                            ...
                            <div class="col-8">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title">Liste des modèles de tetra</h4>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade" id="editModal{{ $model->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $model->id }}" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <form action="{{ route('model-tetra.update', $model->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('PUT')
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="editModalLabel{{ $model->id }}">Modifier le modèle de tetra</h5>
                                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <div class="mb-3">
                                                                                <label for="name{{ $model->id }}" class="form-label">Nom du Tetra</label>
                                                        ...
                                                        <form action="{{ route('model-tetra.destroy', $model->id) }}" method="POST" style="display: inline;">
                                                            @csrf
                                                            @method('DELETE')
                            ...
                            <div class="col-4">
                                <div class="card">
                                    ...
                                    <form action="{{ route('model-tetra.store') }}" method="POST">
                                            ...
                                            <input type="text" name="name" class="form-control" placeholder="Nom du modèle de tetra" required>
