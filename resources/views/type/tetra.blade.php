                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-8">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title">Liste des types de tetra</h4>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade" id="editModal{{ $type->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $type->id }}" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <form action="{{ route('type-tetra.update', $type->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('PUT')
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="editModalLabel{{ $type->id }}">Modifier le type de Tetra</h5>
                                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <div class="mb-3">
                                                                                <label for="name{{ $type->id }}" class="form-label">Nom du Tetra</label>
                                                        ...
                                                        <form action="{{ route('type-tetra.destroy', $type->id) }}" method="POST" style="display: inline;">
                                                            @csrf
                                                            @method('DELETE')
                            ...
                            <div class="col-4">
                                <div class="card">
                                    <div class="card-body">
                                        <form action="{{ route('type-tetra.store') }}" method="POST">
                                            @csrf
                                            <label for="">Type de Tetra</label>
                                            <input type="text" name="name" class="form-control" placeholder="Nom du type de tetra">
