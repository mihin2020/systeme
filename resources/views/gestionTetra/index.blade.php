    ...
    <div class="page-content">
        ...
        <div class="px-3">
            <div class="container mt-5">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <form action="{{ route('gestionTetra.store') }}" method="POST">
                                    ...
                                    <div style="display: flex; gap: 20px; flex-wrap: wrap;">
                                        ...
                                        <div style="flex: 1; min-width: 300px;">
                                            <div class="mb-3">
                                                <label for="numero_group" class="form-label">N° group :</label>
                                                <input type="text" name="numero_group" class="form-control" required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="security_group" class="form-control" required>
                                                @error('security_group') <span class="text-danger">{{ $message }}</span> @enderror
                                            </div>
                                            <div class="mb-3">
                                                <label for="talk_group" class="form-label">Talk group :</label>
                                                <input type="text" name="talk_group" class="form-control" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="{{ route('model-tetra.store') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                            ...
                                            <div class="modal-content">
                                                <form id="editForm" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            <label for="name" class="form-label">Nom de la radio</label>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form id="deleteForm" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Êtes-vous sûr de vouloir supprimer ce modèle de Tetra ? Cette action est irréversible.</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <a href="{{ route('tetras.export') }}" class="btn btn-success">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title">Liste des TETRA</h4>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        openEditModalBtn.addEventListener('click', function() {
            ...
            editForm.action = `/model-tetra/${selectedId}`;
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        supprimerBtn.addEventListener('click', function() {
            ...
            deleteForm.action = `/model-tetra/${selectedId}`;
            deleteModal.show();
        });
    });
</script>